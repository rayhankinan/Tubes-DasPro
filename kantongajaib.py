...
def findallLib(library, key, val):
    res = []
    for i in range(len(library[key])):
        if library[key][i] == val:
            res.append(i)
...
def findcategoryLib(library, key, category, val):
    res = []
    if category == "=":
        for i in range(len(library[key])):
            if library[key][i] == val:
...
def carirarity():
    ...
    rarity = input("Masukkan rarity: ") # Pasti valid menurut spesifikasi
...
def caritahun():
    ...
    tahun = input("Masukkan tahun: ") # Pasti valid menurut spesifikasi
    jenisKategori = input("Masukkan kategori: ") # Pasti valid menurut spesifikasi
